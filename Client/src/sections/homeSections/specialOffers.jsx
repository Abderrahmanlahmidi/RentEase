            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600">
                        Discover limited-time deals on beautiful homes
                    </p>
                </motion.div>
                ...
                {specialDeals.length > 0 ? (
                                    ...
                                    >
                                        <div className="bg-white border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-sm h-full flex flex-col">
                                            <div className="relative h-56 overflow-hidden">
                                                <img
                                                    src={`http://localhost:8000/storage/${deal.images[0]?.url}`}
                                                    alt={deal.titre}
                                                ...
                                                <div className="absolute top-4 left-4 bg-black px-3 py-1 flex items-center">
                                                    ...
                                                    <span className="text-sm font-medium text-white">Special Deal</span>
                                                </div>
                                            </div>
                    ...
                    <div className="text-center mt-12 bg-white border border-gray-200 p-10 max-w-2xl mx-auto">
                        ...
                        <p className="text-gray-600 mb-6">
                            We're currently updating our special offers. Please check back later or browse our regular listings.
                        </p>
                        <button
